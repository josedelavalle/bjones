        ...
        function print() {
            ...
            for (var i = 0; i < 42; i++) {
                ...
                if (i < dWeekDayOfMonthStart) {
                    ...
                    console.log(settings.events.length);
            ...
            for (var i = 0; i < settings.events.length; i++) {
                ...
                if (d.getMonth() == dMonth && d.getFullYear() == dYear) {
                    ...
                    if (lpad(d.getHours(), 2) > 12) {
                        date = date + (lpad(d.getHours(), 2) - 12) + ':' + lpad(d.getMinutes(), 2) + ' pm';
                    } else {
                        date = date + lpad(d.getHours(), 2) + ':' + lpad(d.getMinutes(), 2) + ' am';
                    }
                    
                    var item = $('<div/>').addClass('c-event-item');
                    var title = $('<div/>').addClass('title').html(date + '<br/>' + settings.events[i].title + '<br/>');
